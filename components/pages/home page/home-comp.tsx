...
export function HomePageComp() {
  ...
  useEffect(() => {
    const targetDate = new Date('2025-01-10T23:59:59').getTime()
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-black via-gray-500 to-red-500">
      <div className="text-center text-white p-8 rounded-lg shadow-2xl bg-black bg-opacity-50 backdrop-blur-md">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">{`Welcome To Get Equities`}</h1>
